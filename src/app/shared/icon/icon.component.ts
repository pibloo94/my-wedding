    ...
    >
      @switch (name()) {
        ...
        @case ('glass') {
          ...
          <path d="M8 22h8"/>
          <path d="M12 15v7"/>
          <path d="M17 3H7l1.2 4.8A5.4 5.4 0 0 0 12 14a5.4 5.4 0 0 0 3.8-6.2L17 3Z"/>
          <path d="M9.2 8h5.6"/>
        }
        @case ('utensils') {
        ...
        @case ('party-popper') {
          ...
          <path d="M15 2h.01"/>
          <path d="M22 20h.01"/>
          <path d="m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12v.1c-.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10 22 2Z"/>
          <path d="m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11-.11.7-.63 1.22-1.33 1.33L16 16"/>
          <path d="m11 14 .29.66c.24.57.1 1.24-.35 1.66l-.92.86c-.57.53-.7 1.4-.3 2.07.4.68 1.2.97 1.94.7l.66-.24c.58-.21 1.23.05 1.52.59L14 22"/>
        }
        @case ('check-circle') {
          <circle cx="12" cy="12" r="10"/>
